...
I used the YouTube API to fetch the latest three videos from each creator and generated transcripts using the Supadata API. I also manually went through the LinkedIn profiles of these creators and extracted key insights from their most recent posts.

One thing I noticed was that not every creator provided the same level of value across platforms. Because of this, I focused on collecting and documenting only the most noteworthy and useful information rather than scraping everything indiscriminately.
